...
<a class="c2" href="adminviewreport.php"><input type="submit" name="submit" value="View REPORT"></a>
<a class="c3" href="daftaradmin.php"><input type="submit" name="submit" value="Register New ADMIN"></a>
<a class="c4" href="accountview.php"><input type="submit" name="submit" value="View USERS Account"></a>
